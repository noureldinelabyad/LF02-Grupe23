...
class TestCalculation(unittest.TestCase):
    ...
    def test_discount_none(self):
        self.assertEqual(calculation.apply_discount(10, None), 10)

    def test_discount_error(self):
        self.assertEqual(calculation.apply_discount(10, "Test"), errors.wrong_discount)
    ...
    def test_disctance_rate_error(self):
        self.assertEqual(calculation.calculate_amount_by_distance(1, "kilometter"), errors.wrong_unit)
    ...
    def test_time_rate_error(self):
        self.assertEqual(calculation.calculate_amount_by_time(1, "mineuten"), errors.wrong_unit)